<nav class="navbar navbar-expand-lg bg-secondary sticky-top">
  <div class="container-fluid bg-dark">
    ...
    <img src="./img/Slime Jump Mini Games.gif" alt="Logo" width="40" height="34" class="d-inline-block align-text-top">
        Ridwan Ilham</a>
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      <ul class="navbar-nav me-auto mb-2 mb-lg-0">
        ...
        <li class="nav-item">
          <a class="nav-link text-light " href="/" aria-disabled="true">Kembali</a>
        </li>
      </ul>
