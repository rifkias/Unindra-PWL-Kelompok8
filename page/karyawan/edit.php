                    ...
                    <div class="card-body">
                        <form action="" method="POST">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control <?= isset($error['employe_name']) ? 'is-invalid' : "" ?> " name="employe_name" placeholder="Nama Karyawan" value="<?= @$_POST['employe_name'] ?: $value['employe_name'] ?>">
                                <?php
                            ...
                            <div class="form-group">
                                ...
                                <input type="date" class="form-control <?= isset($error['date_of_birth']) ? 'is-invalid' : "" ?> " name="date_of_birth" placeholder="Tanggal Lahir" value="<?= @$_POST['date_of_birth'] ?: $value['date_of_birth']  ?>">
                                <?php
                            ...
                            <div class="form-group">
                                <label for="">NIK</label>
                                <input type="text" class="form-control <?= isset($error['nik']) ? 'is-invalid' : "" ?> " name="nik" placeholder="NIK" value="<?= @$_POST['nik'] ?: $value['nik'] ?>">
                                <?php
                                if (isset($error['nik'])) {
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control <?= isset($error['username']) ? 'is-invalid' : "" ?> " name="username" placeholder="Username" value="<?= @$_POST['username']  ?: $value['username']  ?>">
                                <?php
                            ...
                            <div class="form-group">
                                ...
                                <input type="number" class="form-control <?= isset($error['salary']) ? 'is-invalid' : "" ?> " name="salary" placeholder="Gaji" value="<?= @$_POST['salary']  ?: $value['salary'] ?>">
                                <?php
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control <?= isset($error['role']) ? 'is-invalid' : "" ?> " name="role" placeholder="Nama Lokasi" value="<?= @$_POST['role']   ?: $value['role']  ?>">
                                <?php
                                if (isset($error['role'])) {
                            ...
                            <div class="form-group">
                                ...
                                <select name="is_active" class="form-control <?= isset($error['is_active']) ? 'is-invalid' : "" ?> ">
                                    ...
                                    <option value="1" <?= (@$_POST['is_active'] ?: $value['is_active']) === '1' ? "selected" : "" ?>> Aktif </option>
                                    <option value="0" <?= (@$_POST['is_active'] ?: $value['is_active']) === '0' ? "selected" : "" ?>>Tidak Aktif</option>
                                </select>
                                <?php
...
<script>
    $(document).ready(function() {
        ...
        <?php
        if (isset($_POST['location_id']) || isset($value['location_id'])) {
            $id = @$_POST['location_id'] ?: $value['location_id'];
        ?>
